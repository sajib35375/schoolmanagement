            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Add New Category Fee</h4>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <form id="amount_form" action="{{ route('fee.amount.store') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="add_items">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <h5>Select Student Year <span class="text-danger">*</span></h5>
                                                        <div class="controls">
