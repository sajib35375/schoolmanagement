            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('update.assign_subject',$assign_single->class_id) }}" method="POST">
                            @csrf
                                    ...
                                    <div class="form-group mb-5">
                                        ...
                                        <select required class="form-control" name="class_id" id="">
                                            ...
                                            @foreach($classes as $class)
                                                <option {{ $assign_single->class_id == $class->id ? 'selected' : '' }} value="{{ $class->id }}">{{ $class->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="add_item">
                                <div class="row mt-10">
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <select required class="form-control" name="subject_id[]" id="">
                                                ...
                                                @foreach($subjects as $subject)
                                                    <option {{ $assign->subject_id == $subject->id ? 'selected' : '' }} value="{{ $subject->id }}">{{ $subject->subject }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        ...
                                        <input required name="full_mark[]" value="{{ $assign->full_mark }}" class="form-control" type="text">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="">Pass Mark</label>
                                        <input required name="pass_mark[]" value="{{ $assign->pass_mark }}" class="form-control" type="text">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="">Subjective Mark</label>
                                        <input required name="subjective_mark[]" value="{{ $assign->subjective_mark }}" class="form-control" type="text">
                                    </div>
    ...
    <script>
        jQuery(document).ready(function (){
            ...
            jQuery(document).on('click','.deleterowitem',function (){
                jQuery(this).closest('.add_item').remove();
