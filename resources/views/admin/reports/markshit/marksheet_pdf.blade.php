        ...
        <div class="col-md-12 col-12">
            <div class="box box-solid box-inverse box-info">
              <div class="box-header with-border">
                <h4 class="box-title">Mark Sheet <strong>View</strong></h4>
...
@php
    $assign_stu = App\Models\AssignStudent::where('year_id',$all_student['0']->year_id)->where('class_id',$all_student['0']->class_id)->first();
@endphp
                   ...
                   <div class="row">
                        <div class="col-md-6">
                            <table border="1" style="border-collapse: #ffffff; width: 100%;" cellpadding="1" cellsacing="2">
                                <tr>
                                    <td>Student Name</td>
                                    <td>{{ $all_student['0']['student']['name'] }}</td>
                                </tr>

                                <tr>
                                    <td>Student ID</td>
                                    <td>{{ $all_student['0']['id_no'] }}</td>
                                </tr>
                                <tr>
                                    <td>Student Class</td>
...
$total_grade = App\Models\Grade::where([['start_point','<=',$point_for_letter_grade],['end_point','>=',$point_for_letter_grade]])->first();
