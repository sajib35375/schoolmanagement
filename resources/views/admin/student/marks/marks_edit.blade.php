            ...
            <div class="col-md-12" style="display: block; margin: auto;">
                <div class="box box-solid bg-secondary">
                    <div class="box-header">
                        <h4 class="box-title"><strong>Student Marks Edit</strong></h4>
                    </div>

                    <div class="box-body" >

                        <form action="{{ route('subject.mark.update') }}" method="POST">
                            @csrf
                            <div class="row" >
                                <div class="col-md-3">
                   ...
                   success:function (data){
                     ...
                     jQuery.each(data,function (key,val){
                         html += `
                            ...
                            <td><input value="${val.marks}" name="marks[]"></td>

                        </tr>

                         `;
                     })
                       jQuery('#Student_Marks_edit').html(html);
                   }
               })
