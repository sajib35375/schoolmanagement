            ...
            <div class="col-md-12" style="display: block; margin: auto;">
                <div class="box box-solid bg-secondary">
                    <div class="box-header">
                        <h4 class="box-title"><strong>Add Other Student Fee</strong></h4>
                    </div>
...
{{--                                        <option value="{{ $data->id }}">{{ $data->fee_name }}</option>--}}
{{--                                    @endforeach--}}
{{--                                </select>--}}
{{--                            </div>--}}
                            ...
                            <div class="col-md-3" style="padding-top: 8px;">
                                <a id="search" href="#" class="btn btn-success">Search</a>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="DocumentResults">
                                    ...
                                    <script id="document-template" type="text/x-handlebars-template">
                                        <form action="{{ route('submit.account.fee.store') }}" method="POST">
                                            @csrf
    ...
    <script type="text/javascript">
        $(document).on('click','#search',function(){
            ...
            $.ajax({
                url: "{{ route('submit.other.fee.search')}}",
                type: "GET",
